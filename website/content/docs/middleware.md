---
title: "Middleware"
description: "Compose cross-cutting behavior as Handler -> Handler."
group: "Core"
order: 2
---
...
Firefly includes 15+ built-in middleware modules. A middleware is a function that wraps a handler:
