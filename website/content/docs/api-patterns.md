---
title: "API Patterns"
description: "Idiomatic patterns for building HTTP APIs."
group: "Core"
order: 6
---
...
Firefly includes modules for common REST API patterns: pagination, versioning, HATEOAS, and bulk operations.
