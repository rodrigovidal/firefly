---
title: "Validation"
description: "Zod-like typed schemas and request validation."
group: "Core"
order: 3
---
...
Firefly integrates with [Flame](https://github.com/example/flame), a schema validation library for F#. Flame provides type-safe parsing, validation rules, and JSON Schema generation.
